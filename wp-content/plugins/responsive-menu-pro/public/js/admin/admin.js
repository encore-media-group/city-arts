jQuery(function($) {
    ...
    $(document).on('click', '#responsive-menu-pro-preview', function(e) {
        e.preventDefault();
    ...
    $(document).on('click', '.scroll-to-option', function(e) {
        ...
        $('#responsive-menu-pro-current-page').val(parent_panel_id);
    ...
    $(document).on('click', '.nav-tabs li a', function() {
        ...
        $('#responsive-menu-pro-current-page').val(tab_name);
    });
    ...
    $('#responsive-menu-pro-button-trigger-type').selectize({
